    ...
    internal class Render2DLightingPass : ScriptableRenderPass, IRenderPass2D
    {
            ...
            ref RenderTextureDescriptor desc)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingDrawRenderers))
            {
                ...
                CoreUtils.SetRenderTarget(cmd, colorAttachment, RenderBufferLoadAction.Load, RenderBufferStoreAction.Store,
                    depthAttachment, RenderBufferLoadAction.Load, depthStore, //ClearFlag.None, Color.white);
                    ClearFlag.All, renderingData.cameraData.camera.backgroundColor);
